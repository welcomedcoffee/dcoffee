...
class Students extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['stu_name', 'stu_nickname', 'stu_card', 'card_positive', 'card_reverse', 'stu_sex', 'stu_height', 'stu_school', 'stu_professional', 'stu_code', 'stu_start', 'stu_end', 'province_id', 'city_id', 'area_id', 'stu_addr', 'skills_id', 'stu_parttime', 'stu_introduction', 'stu_experience', 'stu_pwd', 'stu_avatar', 'stu_money', 'stu_limit_money', 'stu_addtime', 'stu_updtime'], 'required'],
